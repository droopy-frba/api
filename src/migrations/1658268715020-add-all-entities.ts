...
export class addAllEntities1658268715020 implements MigrationInterface {
    name = 'addAllEntities1658268715020'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`user\` (\`uuid\` varchar(36) NOT NULL, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` timestamp(6) NULL, \`name\` varchar(255) NOT NULL, \`last_name\` varchar(255) NOT NULL, \`email\` varchar(255) NOT NULL, \`password\` varchar(255) NOT NULL, \`verificationToken\` varchar(255) NOT NULL, \`activation_status\` varchar(255) NOT NULL, \`role\` int NOT NULL, UNIQUE INDEX \`IDX_e12875dfb3b1d92d7d7c5377e2\` (\`email\`), PRIMARY KEY (\`uuid\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`consumer\` (\`uuid\` varchar(36) NOT NULL, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` timestamp(6) NULL, \`name\` varchar(255) NOT NULL, \`identifier\` varchar(255) NOT NULL, PRIMARY KEY (\`uuid\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`film_search\` (\`uuid\` varchar(36) NOT NULL, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` timestamp(6) NULL, \`title\` varchar(255) NOT NULL, \`description\` varchar(255) NOT NULL, \`status\` int NOT NULL, \`phone_model\` varchar(255) NOT NULL, \`review\` int NOT NULL, \`expirationDate\` timestamp NOT NULL, \`consumerUuid\` varchar(36) NULL, PRIMARY KEY (\`uuid\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`filmmaker\` (\`uuid\` varchar(36) NOT NULL, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` timestamp(6) NULL, \`phone_brand\` varchar(255) NOT NULL, \`phone_model\` varchar(255) NOT NULL, \`review\` int NOT NULL, PRIMARY KEY (\`uuid\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`suscription\` (\`uuid\` varchar(36) NOT NULL, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` timestamp(6) NULL, \`hours\` int NOT NULL, \`available_hours\` int NOT NULL, \`status\` int NOT NULL, \`companyUuid\` varchar(36) NULL, PRIMARY KEY (\`uuid\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`film_search\` ADD \`locationLatitude\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`film_search\` ADD \`locationLongitude\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`film_search\` ADD \`locationDescription\` varchar(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`consumer\` DROP FOREIGN KEY \`FK_7e77e4a29905b0ac429b40b3240\``);
        await queryRunner.query(`ALTER TABLE \`film_search\` DROP COLUMN \`locationDescription\``);
        await queryRunner.query(`ALTER TABLE \`film_search\` DROP COLUMN \`locationLongitude\``);
        await queryRunner.query(`ALTER TABLE \`film_search\` DROP COLUMN \`locationLatitude\``);
